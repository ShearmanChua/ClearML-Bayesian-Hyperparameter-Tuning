...
task = Task.init(project_name='BO_tuning_3', task_name='base task')
...
Logger.current_logger().report_scalar(title='evaluate', series='loss', value=score[0], iteration=args['epochs'])
